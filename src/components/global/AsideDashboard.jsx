                ...
                <ul className="space-y-6 mt-6">
                    <li>
                        ...
                        >
                            ...
                            >
                                <path
                                    d="M21,12c0-0.532-0.052-1.075-0.154-1.622l1.933-1.708l-2.505-4.339l-2.442,0.818c-0.83-0.705-1.786-1.256-2.812-1.621	L14.505,1h-5.01L8.981,3.528C7.955,3.893,6.999,4.444,6.169,5.149L3.727,4.331L1.222,8.669l1.933,1.708C3.052,10.925,3,11.468,3,12	s0.052,1.075,0.154,1.622l-1.933,1.708l2.505,4.339l2.442-0.818c0.83,0.705,1.786,1.256,2.812,1.621L9.495,23h5.01l0.514-2.528	c1.026-0.365,1.982-0.917,2.812-1.621l2.442,0.818l2.505-4.339l-1.933-1.708C20.948,13.075,21,12.532,21,12z M12,15.5	c-1.933,0-3.5-1.567-3.5-3.5s1.567-3.5,3.5-3.5s3.5,1.567,3.5,3.5S13.933,15.5,12,15.5z"
                                    fill="black"
                                ></path>{" "}
                            </svg>
                            Configuración
                    ...
                    <li>
                        <Link
                            href="/cerrar-sesion"
                            className="text-[#ff6464] hover:text-[#ff4f4f] font-serif"
                        >
                            <img className="w-[20px]" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAVElEQVR4nM3TXQoAEBAE4LmruYdXtx4pD36LJZnyZr7aLCBHpFYPRtEtANboBaB0x7lwBnCCaAcYIWqApRcpEVkA0ttHKMsGoC5vAn0ZX23i898YAc2dIij/HCI2AAAAAElFTkSuQmCC" alt="exit" />
                            Cerrar sesión
                        </Link>
                    </li>
                </ul>
