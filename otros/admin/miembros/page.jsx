...
function EditUserModal({ user, onClose }) {
    ...
    return (
        <div
            className={`
        fixed inset-0 z-50 flex items-center justify-center bg-[#ffffff9d] backdrop-blur-[5px]
      ...
      `}
        ...
        >
            <div
                className={`
          bg-[#ececec] w-[500px] max-w-full p-6 rounded-3xl shadow-[#bdbdbd] shadow-xl relative
            ...
            >
                ...
                <div className="mt-6 flex justify-between text-xs font-bold font-serif">
                    ...
                    >
                        ...
                        <span className="text-[white]">Eliminar usuario</span>
                    </button>
                    <div className="space-x-2 flex items-center">
                        <button
                            onClick={handleClose}
                            className="p-3 border-2 text-black rounded-2xl border-black"
                        >
                            Cancelar
                        </button>
                        <button
                            onClick={handleSave}
                            className="text-white p-3 bg-gradient-to-r from-[#06869B] via-[#11809D] to-[#1B607A] rounded-2xl"
                        >
                            Guardar cambios
                        </button>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-start gap-6 pt-32">
                            ...
                            <div className="w-2/3">
                                ...
                                <table className="w-full bg-[#f0f0f0] rounded-xl overflow-hidden border border-gray-200 border-separate [border-spacing:0]">
                                    ...
                                    <tbody>
                                        {miembros.map((miembro, index) => (
                                            <tr
                                                key={index}
                                                className="border-b border-gray-500 hover:bg-[#e4e4e4]"
                                            >
                                                ...
                                                <td className="py-2 px-4 text-black font-serif">
                                                    {miembro.correo}
                                                </td>
                                                <td className="py-2 px-4 text-black font-serif">
